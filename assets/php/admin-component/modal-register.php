        ...
        <div class="auth-form">
            <div class="auth-form__container">
                <div class="auth-form__header">
                    ...
                    <span class="auth-form__switch-button"><a href="index.php?action=login">Đăng nhập</a></span>
                </div>
                <form action="index.php?action=register" method="post">
                    <div class="auth-form__form">
                        ...
                        <div class="auth-form__group">
                            <input type="password" name="confirm" class="auth-form__input" placeholder="Nhập lại mật khẩu">
                        </div>
                    </div>

                    <div class="auth-form__aside">
                        <p class="auth-form__policy-text">
                            Bằng việc đăng ký, bạn đã đồng ý với Y&M về
