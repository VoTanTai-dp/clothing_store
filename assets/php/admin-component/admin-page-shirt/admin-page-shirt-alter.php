...
$sql_alter = "SELECT * FROM TEE_SHIRTS WHERE T_ID = '".$_GET['idsanpham']."' LIMIT 1";
...
<div class="product__insert">
    ...
    <ul class="product__list">
        <li class="product__item">
            ...
            <input type="text" value="<?php echo $dong['T_ID']?>" name="idsanpham" class="product__item-input">
        </li>
        <li class="product__item">
        ...
        <li class="product__item">
            ...
            <input type="text" value="<?php echo $dong['T_TITLE']?>" name="tensanpham" class="product__item-input">
        </li>
        <li class="product__item">
        ...
        <li class="product__item">
            ...
            <input type="text" value="<?php echo $dong['T_PRICE']?>" name="giasanpham" class="product__item-input">
        </li>
        <li class="product__item">
            <span class="product__item-name">Giảm giá:</span>
            <input type="text" value="<?php echo $dong['T_DISCOUNT']?>" name="giamgia" class="product__item-input">
        </li>
        <li class="product__item">
            <span class="product__item-name">Số lượng:</span>
            <input type="text" value="<?php echo $dong['T_QUANTITY']?>" name="soluong" class="product__item-input">
        </li>
        <li class="product__item">
            <span class="product__item-name">Ảnh minh họa:</span>
            <input type="file" value="<?php echo $dong['T_ILLUSTRATION']?>" name="anhminhhoa" class="product__item-input">
        </li>
        <li class="product__item">
            <span class="product__item-name">Mô tả:</span>
            <input type="text" value="<?php echo $dong['T_DESCRPTION']?>" name="mota" class="product__item-input product__item-input--description">
        </li>
        <li class="product__item">
