...
<form method="POST" action="assets\php\admin-component\admin-page-pant\admin-page-pant-process.php" enctype="multipart/form-data">
<div class="product__insert">
    <h3 class="product__title">Thêm sản phẩm quần:</h3>
